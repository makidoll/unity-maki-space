...
//     version 1.4.4
//     from Assets/Unity Maki Space/Unity Maki Space Input Actions.inputactions
//
...
public partial class @UnityMakiSpaceInputActions : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @UnityMakiSpaceInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""Unity Maki Space Input Actions"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @UnityMakiSpaceInputActions m_Wrapper;
        public PlayerActions(@UnityMakiSpaceInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @UnityMakiSpaceInputActions m_Wrapper;
        public UIActions(@UnityMakiSpaceInputActions wrapper) { m_Wrapper = wrapper; }
